		...
		data: [
		  {
			...
			dataPoints: [
			  { y: data.powerstats.intelligence, indexLabel: "Intelligence" },
			  { y: data.powerstats.strength, indexLabel: "Strength" },
			  { y: data.powerstats.speed, indexLabel: "Speed" },
			  { y: data.powerstats.durability, indexLabel: "Durability" },
			  { y: data.powerstats.power, indexLabel: "Power" },
			  { y: data.powerstats.combat, indexLabel: "Combat" }
			]
		  }
		]
	  });
